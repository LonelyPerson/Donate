    ...
    popConfirm: function (options) {
      ...
      return this.each(function () {
        ...
        self.popover({
          ...
          content: options.content + '<p class="button-group" style="margin-top: 10px; text-align: center;"><button type="button" class="btn btn-sm confirm-dialog-btn-abord">' + options.noBtn + '</button> <button type="button" class="btn btn-sm btn-danger confirm-dialog-btn-confirm">' + options.yesBtn + '</button></p>'
        }).click(function (e) {
          if (last && last !== self) {
