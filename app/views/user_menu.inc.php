    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <ul class="nav nav-pills nav-stacked">
                ...
                <?php } ?>
                <li id="balance"><a href="javacript: void(0);" onclick="loadView('balance'); return false;"><?=Language::_('Balansas');?> (<span><?=Auth::user()->balance?></span>) <i class="fa fa-money pull-right"></i></a></li>
